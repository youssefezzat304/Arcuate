...
const word = {
  text: 'Sonne',
  language: 'de',
  sourceTextId: '123e4567-e89b-42d3-a456-426614174000',
  sourceTitle: 'Solarenergie',
};
...
test('removal reads the latest list and deletion leaves other lists intact', () => {
  ...
  assert.deepEqual(
    updated.words.map((item) => item.text),
    ['Licht'],
  );
...
test('management storage failures propagate without losing data', (t) => {
  ...
  t.mock.method(localStorage, 'removeItem', () => {
    throw new Error('Storage blocked');
  });
